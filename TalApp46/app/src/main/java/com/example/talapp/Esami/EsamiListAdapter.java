...
public class EsamiListAdapter extends RecyclerView.Adapter<EsamiListAdapter.EsamiViewHolder> {
    ...
    public class EsamiViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(DocumentSnapshot documentSnapshot, int position) {
            ...
            if(esame.containsKey(KEY_REFERTO)) referto.setText("Referto: SI");
            else referto.setText("Referto: NO");

            TextView digiuno = itemView.findViewById(R.id.textViewDigiuno);
            if(esame.containsKey(KEY_DIGIUNO)) digiuno.setText("Digiuno: SI");
            else digiuno.setText("Digiuno: NO");

            TextView attivazione = itemView.findViewById(R.id.textViewAttivazione);
            ...
            else attivazione.setText("Attivazione 24: NO");
