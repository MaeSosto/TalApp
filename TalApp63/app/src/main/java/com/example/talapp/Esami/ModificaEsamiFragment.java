...
import static com.example.talapp.Esami.AnalisiListAdapter.KEY_MODIFICA;
...
public class ModificaEsamiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root.findViewById(R.id.buttonModificaTerapia).setOnClickListener(v -> modificaEsame());
    ...
    private void getInfoEsame() {
        ...
        esamiRef.document(id).get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                analisiListAdapter.setAnalisi((List<Map<String, Object>>) esame_old.get(KEY_ANALISI));
    ...
    private static void updateEsito(String nome, Double esito){
