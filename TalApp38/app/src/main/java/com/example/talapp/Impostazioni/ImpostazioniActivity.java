...
public class ImpostazioniActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonSalvaImpostazioni).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateSettings(switchEsameStrumentale, editTextEsameStrumentale, IMPOSTAZIONI_ESAME_STRUMENTALI, IMPOSTAZIONI_ESAME_STRUMENTALI_ORARIO);
                updateSettings(switchEsameStrumentalePeriodici, editTextEsameStrumentalEPeriodici, IMPOSTAZIONI_ESAMI_STRUMENTALI_PERIODICI, IMPOSTAZIONI_ESAMI_STRUMENTALI_PERIODICI_ORARIO);
                updateSettings(switchEsameLaboratorio, editTextEsameDiLaboratorio, IMPOSTAZIONI_ESAME_LABORATORIO, IMPOSTAZIONI_ESAME_LABORATORIO_ORARIO);
                updateSettings(switchEsameLaboratorioPeriodici, editTextEsameDiLaboratorioPeriodici, IMPOSTAZIONI_ESAMI_LABORATORIO_PERIODICI, IMPOSTAZIONI_ESAMI_LABORATORIO_PERIODICI_ORARIO);
        ...
        findViewById(R.id.buttonDisconnetti).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               //Rimuovo tutti gli allarmi
               //ForegroundService.removeAlarms();
    ...
    private void updateSettings(Switch s, EditText ETOrario, String CampoBooleano, String CampoOrario){
        ...
        if(s.isChecked()) {
            try {
                impostazioni.put(CampoOrario, Util.ConverterStringToDate(ETOrario.getText().toString()));
