...
public class ImpostazioniActivity extends AppCompatActivity {
    ...
    private void updateSettings(Switch s, EditText ETOrario, String CampoBooleano, String CampoOrario, int IDAllarme){
        ...
        if(s.isChecked()) {
            try {
                ...
                Alarm.setAlarm(Util.ConverterStringToDate(ETOrario.getText().toString()), IDAllarme, CampoBooleano);
            ...
            Alarm.removeAlarm(IDAllarme, CampoBooleano);
        }
    }
}