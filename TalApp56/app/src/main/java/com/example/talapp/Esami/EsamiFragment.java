...
public class EsamiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonAggiungiEsame = root.findViewById(R.id.buttonAggiungiEsame);
        buttonAggiungiEsame.setOnClickListener(v -> Navigation.findNavController(root).navigate(R.id.action_esamiFragment_to_aggiungiEsamiFragment));
