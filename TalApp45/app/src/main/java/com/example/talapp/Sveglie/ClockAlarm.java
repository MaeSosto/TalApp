...
public class ClockAlarm extends Service {
    ...
    public static void setAlarm(Date Orario, String idSveglia){
        ...
        bundle.putString("SVEGLIA", idSveglia);
        bundle.putInt("ID", ID);
        ...
        alarmManager.setRepeating(android.app.AlarmManager.RTC_WAKEUP, Calendar.getInstance().getTimeInMillis(), AlarmManager.RTC_WAKEUP, pendingIntent);
    }
