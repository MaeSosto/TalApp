...
public class TrasfusioniFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonAggiungiTrasfusione.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(root).navigate(R.id.action_trasfusioniFragment_to_aggiungiTrasfusioneFragment);
            }
        });
        ...
        trasfusioniRef.whereLessThan(KEY_DATA, Calendar.getInstance().getTime()).orderBy(KEY_DATA, Query.Direction.DESCENDING).limit(1).addSnapshotListener(new EventListener<QuerySnapshot>() {
                ...
                public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                    if(value.getDocuments().size() > 0){
                        ...
                        buttonCronologiatrasfusioni.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
