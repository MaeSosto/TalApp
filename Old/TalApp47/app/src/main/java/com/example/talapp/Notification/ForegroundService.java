...
import static com.example.talapp.Notification.JobService.ACTION_SET_CLOCK_ALARMS;
...
import static com.example.talapp.Utils.Util.KEY_TERAPIE;
...
public class ForegroundService extends Service {
    ...
    private void createNotificationChannel(){
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            NotificationChannel sveglieChannel = new NotificationChannel(ALARM_CHANNEL, "Sveglie",  android.app.NotificationManager.IMPORTANCE_DEFAULT);
