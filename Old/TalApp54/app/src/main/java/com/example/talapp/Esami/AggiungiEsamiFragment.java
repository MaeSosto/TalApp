...
public class AggiungiEsamiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setSpinner(getResources().getStringArray(R.array.periodicita), Speriodicita);

        //Spinner tipo
        AutoCompleteTextView Stipo = root.findViewById(R.id.spinnerTipoEsame);
        setSpinner(getResources().getStringArray(R.array.TipoEsame), Stipo);
    ...
    private void setSpinner(String[] stringArray, AutoCompleteTextView autoCompleteTextView) {
